...
class Fighter
{
    ...
    public $hitmodificator;
    public $missmodificator;
    public $attackspeed;
    public $criticalhit;
    public $criticalstat;
    public $misspell;
    ...
    */
    public function savetodb($enemy)
    {
        global $db;
    ...
    */
    public function setRingBonus($arrEquip)
    {
    ...
    */
    public function unsetRingBonus($arrEquip)
    {
        $arrStat = array('agility', 'strength', 'inteli', 'wisdom', 'speed', 'cond');
        if ($arrEquip[9][2]) {
            $arrRings = array(AGILITY, STRENGTH, INTELIGENCE, R_WIS3, SPEED, CONDITION);
    ...
    */
    ...
    funkcja liczy obrazenia od luku
    */
    public function setMagicDamage()
    {
    ...
    */
    public function setDamage()
    {
        ...
        //luk + strzaly
        elseif ($this -> equipment[1][6]) {
            $this -> setBowDamage();
        }
        //czar
        elseif ($this -> spell[0][0] && $this -> mana > 0) {
            $this -> setMagicDamage();
        }
        //klepiemy na piesci
        if ($this -> damage == 0) {
    ...
    */
    public function setDefence($arrEquip, $arrSpell)
    {
    ...
    */
    public function setCriticalHit($arrEquip, $arrSpell)
    {
        $this -> criticalstat = 0;
        //bron biala
        if ($arrEquip[0][0]) {
        ...
        //luk + strzaly
        elseif ($arrEquip[1][0] && $arrEquip[6][0]) {
    ...
    */
    public function setHitModificator($arrEquip, $arrSpell)
    {
        $hm = $this -> agility;
        //premie sprzetu
        for ($i=3;$i<=5;$i++) {
        ...
        //luk + strzaly
        elseif ($arrEquip[1][6] && $arrEquip[6][6]) {
            $hm += $this -> shoot;
        }
        //czar
        elseif ($arrSpell[0][0] && $this -> mana > 0) {
            $hm += $this -> magic;
        }
        //bonusy klasowe
        if ($this -> clas == 'Wojownik') {
    ...
    */
    public function setMissModificator($arrEquip)
    {
        $mm = $this -> agility;
        //premie sprzetu
        for ($i=3;$i<=5;$i++) {
    ...
    funkcja ustawia wartosc modyfikatora trafienia
    */
    public function setAttackSpeed($arrEquip)
    {
        $asm = $this -> speed;
        //premie sprzetu
        for ($i=1;$i<=2;$i++) {
    ...
    */
    public function setMisspell($arrSpell)
    {
