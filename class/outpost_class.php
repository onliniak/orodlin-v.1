...
class Outpost
{
    ...
    public $morale;
    public $fatigue;
    public $turns;	 // Number of attack points, can be used to attack or get taxes.
    public $attacks;   // Up to 3 attacks on the outpost per reset.

    public $warriors;
    public $archers;
    public $catapults;
    public $barricades;
    public $lairs;	 // Number of lairs for beasts (Familiars from core.php)
    public $barracks;  // Number of barracks for veterans (troops with equipment).

    public $bonusAttack;   // Leadership bonuses.
    public $bonusDefense;
    public $bonusTax;
    public $bonusGold; // Pay less for keeping the troops.
    public $bonusLost; // Lose less troops in fights.

    public $db;	// reference to database object.
    ...
    public $attack;
    public $defense;
    public $enemyMoraleMod;	// Negative morale for enemy troops, based on outpost's monsters.
    public $lostWarriors = 0;
    public $lostArchers = 0;
    public $lostCatapults = 0;
    public $lostBarricades = 0;
    public $intGainGold = 0;
    public $fltGainLeadership = 0;
    public $arrDeadMon;		// ID's and names of dead monsters and veterans.
    public $arrDeadVet;
    ...
    */
    ...
    public function &getBeasts($blnCompact = false) // outpost's monsters. If "true", gets only general data (for "outposts.php?view=my").
    {
        if ($blnCompact) {
    ...
    public function addBeast($intId, &$arrMonsters, &$arrCores, &$arrNames)
    {
    ...
    public function &getFamiliars(&$arrNames) // normal player's familiars, to be added to outpost
    {
    ...
    public function &getVeterans($blnCompact = false)   //If "true", gets only general data (for "outposts.php?view=my").
    {
        if ($blnCompact) {
    ...
    public function &getVeteran($intId)   //Gets detailed info about one veteran.
    {
    ...
    public function getTaxes($intTimes)
    {
    ...
    public function &getEquipment($charType)
    {
    ...
    public function attack(&$objEnemyOut)
    {
    ...
    public function moraleModifier(&$objEnemy)
    {
    ...
    public function writeData($blnExtended = false) // if true, apply also leadership bonus
    {
    ...
    public function lostspecials() // no more than 3 monsters and 3 veterans in one battle
    {
    ...
    public function battlereport($blnDefender = true)  // Return info about lost armies as <ul><li>... html. If "true", add also amount of lost barricades.
    {
    ...
    */
    public function checkresources($strImprovement, $intArg1, $intArg2)
    {
    ...
    */
    public function upgrade($strImprovement, $intN, &$intArg1, &$intArg2)
    {
        if ($strImprovement == 'size') {
    ...
    */
    public function buyArmy(&$arrInput)
    {
        $intSum = 0;
    ...
    public function addVeteran(&$arrVeterans)
    {
        if ($this -> gold < 1000) {
            return NO_MONEY;
        }
    ...
    public function modifyVeteran(&$arrVeterans)
    {
        $blnMy = false;
