...
if ($_GET['action'] == 'race') {
    ...
    $smarty -> assignByRef('RaceNames', $arrRaceNames);
    $smarty -> assignByRef('Races', $arrRaces);
...
if ($_GET['action'] == 'class') {
    ...
    $smarty -> assignByRef('ClassNames', $arrClassNames);
    $smarty -> assignByRef('Classes', $arrClasses);
    if (isset($_GET['select']) && $_GET['select'] != '' && isset($_GET['step']) && $_GET['step'] == 'mark') {
...
if ($_GET['action'] == 'deity') {
    ...
    $smarty -> assignByRef('GodName', $arrGodNames);
    $smarty -> assignByRef('GodOption', $arrOptionName);
    if (isset($_GET['select']) && $_GET['select'] != '' && isset($_GET['step']) && $_GET['step'] == 'mark') {
        if ($player -> deity != '') {
            error(C_BADCHOICE);
        }
        ...
        $smarty -> assignByRef('God', $arrGodNamesPL[$intKey]);
        if ($Changed_loc == "Y") {
            error(C_DS);
        } else {
            error(C_DSELECTED);
