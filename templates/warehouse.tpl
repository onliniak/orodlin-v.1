...
<div class="six columns">
	<a><img class="u-max-full-width" src="images/locations/warehouse.jpg" /></a>
	...
	<table cellspacing="10px">
		...
		<tr>
			...
			<td align="center"><a href="warehouse.php?action=history&amp;item={$smarty.section.i.index}">{if $Graphstyle == "Y"}<img src="" alt="img_{$smarty.const.A_HISTORY}"
						title="{$smarty.const.A_HISTORY}" />{else}{$smarty.const.A_HISTORY}{/if}</a></td>
		</tr>
		{/section}
	</table>
	<br /><br />
	...
	<div class="overflow">{if !empty($Data)}
		...
		<table cellpadding="3px">
			...
			<tr valign="bottom" align="center">
				...
				<td style="font-size:smaller" {if $smarty.section.i.first} {*Display bars and buy/sell amounts. The <td> tag isn't closed on purpose! Other
				<td>'s have colspan=2'*}
