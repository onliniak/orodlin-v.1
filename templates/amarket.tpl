...
{if $View == "market"}
    ...
    <table width="100%">
    <tr>
    <td width="35%"><a href="amarket.php?view=market&amp;lista=type&amp;limit=0"><b><u>{$Tastral}</u></b></a></td>
    <td width="10%"><a href="amarket.php?view=market&amp;lista=number&amp;limit=0"><b><u>{$Tnumber}</u></b></a></td>
    <td width="10%"><a href="amarket.php?view=market&amp;lista=amount&amp;limit=0"><b><u>{$Tamount}</u></b></a></td>
    <td width="10%"><a href="amarket.php?view=market&amp;lista=cost&amp;limit=0"><b><u>{$Tcost}</u></b></a></td>
    <td width="20%"><a href="amarket.php?view=market&amp;lista=seller&amp;limit=0"><b><u>{$Tseller}</u></b></a></td>
...
{if $View == "all"}
    ...
    <table width="50%">
    <tr>
    <td width="50%"><b><u>{$Hname}</u></b></td>
    <td width="25%" align="center"><b><u>{$Hamount}</u></b></td>
    <td width="25%" align="center"><b><u>{$Haction}</u></b></td>
    </tr>
    {section name=all loop=$Name}
        <tr>
        <td>{$Name[all]}</td>
    <td align="center">{$Amount[all]}</td>
    <td align="center"><form method="post" action="amarket.php?view=market&amp;limit=0&amp;lista=id">
