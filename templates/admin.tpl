...
{if $smarty.get.view == "bugreport"}
    {if $smarty.get.step != ""}
        ...
        <form method="post" action="admin.php?view=bugreport&amp;step={$smarty.get.step}"  onsubmit="if (this.bugcomment.value=='') { return confirm('{$smarty.const.EMPTY_COMMENT}') } else { return true; }">
